...
The new defaults are intended to be safer for a **small account such as $30**. They scale risk from equity, keep a free-margin buffer, and focus trading on the highest-liquidity XAUUSD session.
